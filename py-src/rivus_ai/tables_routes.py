...
from rivus_ai.data_loader import DATA_LOADERS
from rivus_ai.auth import get_identity_id
from rivus_ai.datalake.workspace import Workspace
from rivus_ai.workspace_factory import get_workspace as _create_workspace
from rivus_ai.datalake.parquet_utils import sanitize_table_name as parquet_sanitize_table_name
from rivus_ai.datalake.file_manager import save_uploaded_file, is_supported_file
from rivus_ai.datalake.metadata import TableMetadata as DatalakeTableMetadata
...
def open_workspace():
    """Open the RIVUS home directory in the system file manager."""
