...
from rivus_ai.agents.agent_utils import extract_json_objects, extract_code_from_gpt_response
from rivus_ai.agents.agent_data_rec import (
    SHARED_ENVIRONMENT,
...
class DataTransformationAgent(object):
    ...
    def run(self, input_tables, description, prev_messages: list[dict] = [], n=1,
        ...
        from rivus_ai.agents.agent_utils import generate_data_summary
