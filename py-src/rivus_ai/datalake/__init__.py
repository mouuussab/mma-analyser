...
Example usage:
    ...
    from rivus_ai.datalake import Workspace, save_uploaded_file, write_parquet
...
from rivus_ai.datalake.workspace import (
    Workspace,
    WorkspaceWithTempData,
    get_rivus_home,
    get_default_workspace_root,
)
from rivus_ai.datalake.azure_blob_workspace import AzureBlobWorkspace
from rivus_ai.datalake.cached_azure_blob_workspace import CachedAzureBlobWorkspace
from rivus_ai.datalake.cache_manager import GlobalCacheManager

# Metadata types and operations
from rivus_ai.datalake.metadata import (
    TableMetadata,
    ColumnInfo,
    WorkspaceMetadata,
    load_metadata,
...
from rivus_ai.datalake.file_manager import (
    save_uploaded_file,
...
from rivus_ai.datalake.parquet_utils import (
    sanitize_table_name,
    DEFAULT_COMPRESSION,
)
