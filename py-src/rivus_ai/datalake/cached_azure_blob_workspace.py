...
under ``~/.rivus/cache/``.  Reads come from the local mirror
...
Usage::
    ...
    from rivus_ai.datalake.cached_azure_blob_workspace import (
...
from rivus_ai.datalake.parquet_utils import sanitize_table_name
from rivus_ai.datalake.workspace import Workspace, get_rivus_home
    ...
    def __init__(
        ...
        *,
        ...
        if cache_root is None:
            cache_root = get_rivus_home() / "cache"
        ...
        self._upload_executor = ThreadPoolExecutor(
            ...
            thread_name_prefix="rivus_cache_upload",
        )
