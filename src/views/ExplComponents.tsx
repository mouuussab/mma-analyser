...
const explText: Record<'en' | 'fr', {
    showFewerConcepts: string;
    showAllConcepts: string;
    showFirstN: (n: number) => string;
    showAllN: (n: number) => string;
}> = {
    en: {
        showFewerConcepts: "Show fewer concepts",
        showAllConcepts: "Show all concepts",
        showFirstN: (n) => `Show first ${n} concepts`,
        showAllN: (n) => `Show all ${n} concepts`
    },
    fr: {
        showFewerConcepts: "Afficher moins de concepts",
        showAllConcepts: "Afficher tous les concepts",
        showFirstN: (n) => `Afficher les ${n} premiers concepts`,
        showAllN: (n) => `Afficher tous les ${n} concepts`
    }
};
            ...
            <Box sx={{ 
                ...
                {hasMoreConcepts && (
                    <Box sx={{ 
                        ...
                        <Tooltip title={expanded ? explText[appLanguage].showFewerConcepts : explText[appLanguage].showAllConcepts}>
                            <IconButton
                                size="small"
                            ...
                            >
                                <Typography variant="caption">
                                    {expanded 
                                        ? explText[appLanguage].showFirstN(maxCards)
                                        : explText[appLanguage].showAllN(concepts.length)
                                    }
                                </Typography>
                            </IconButton>
                        </Tooltip>
