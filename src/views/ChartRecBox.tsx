...
export const ChartRecBox: FC<ChartRecBoxProps> = function ({ tableId, placeHolderChartId, sx }) {
    ...
    const getQuestion = (): string => {
        return language === 'fr'
            ? "montre quelque chose d'interessant dans les donnees"
    ...
    return (
        <Box sx={{ maxWidth: "600px", display: 'flex', flexDirection: 'column', ...sx }}>
                        ...
                        slotProps={{
                            ...
                            input: {
                                endAdornment: <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.25, flexShrink: 0 }}>
                                    <Tooltip title={language === 'fr' ? "Generer un graphique a partir de la description" : "Generate chart from description"}>
                                        <span>
                                            <IconButton 
                                                size="medium"
            ...
            <Tooltip title={ideas.length > 0 ? (language === 'fr' ? "Actualiser les idees" : "Refresh ideas") : (language === 'fr' ? "Obtenir des idees" : "Get ideas")}>
                <span>
                    <IconButton 
                        size="medium"
