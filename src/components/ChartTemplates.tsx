...
const CHART_TYPE_FR: Record<string, string> = {
    "Auto": "Auto",
    "Scatter Plot": "Nuage de points",
    "Regression": "Regression",
    "Ranged Dot Plot": "Diagramme de points avec plage",
    "Boxplot": "Boite a moustaches",
    "Bar Chart": "Diagramme en barres",
    "Pyramid Chart": "Diagramme pyramidal",
    "Grouped Bar Chart": "Diagramme en barres groupees",
    "Stacked Bar Chart": "Diagramme en barres empilees",
    "Histogram": "Histogramme",
    "Heatmap": "Carte thermique",
    "US Map": "Carte des Etats-Unis",
    "World Map": "Carte du monde",
    "Pie Chart": "Diagramme circulaire",
    "Rose Chart": "Diagramme en rose",
    "Line Chart": "Diagramme en lignes",
    "Dotted Line Chart": "Diagramme en lignes pointillees",
    "Bump Chart": "Diagramme de classement",
    "Area Chart": "Diagramme en aires",
    "Streamgraph": "Graphique en flux",
    "Lollipop Chart": "Diagramme sucette",
    "Density Plot": "Courbe de densite",
    "Candlestick Chart": "Graphique en chandeliers",
    "Waterfall Chart": "Graphique en cascade",
    "Strip Plot": "Diagramme en bandes",
    "Radar Chart": "Diagramme radar",
    "Custom Point": "Point personnalise",
    "Custom Line": "Ligne personnalisee",
    "Custom Bar": "Barre personnalisee",
    "Custom Rect": "Rectangle personnalise",
    "Custom Area": "Aire personnalisee",
};

export function getLocalizedChartType(chartType: string, language: 'en' | 'fr' = 'en'): string {
    if (language === 'fr') {
        const direct = CHART_TYPE_FR[chartType];
        if (direct) return direct;
        const normalized = chartType.trim().toLowerCase();
        const matchedKey = Object.keys(CHART_TYPE_FR).find(k => k.toLowerCase() === normalized);
        return matchedKey ? CHART_TYPE_FR[matchedKey] : chartType;
    }
    return chartType;
}
